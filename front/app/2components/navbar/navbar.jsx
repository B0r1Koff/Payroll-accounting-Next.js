    ...
    return ( 
        ...
        <div className="navbar">
            <div className='nav-start'>
                ...
                <button className='nav-button' onClick={e => router.push("/")}><img className='nav-btn-img' src="https://premiumwebsites.net/wp-content/uploads/2017/10/google-calendar.png" alt="" /></button>
                <button className='nav-button' onClick={e => router.push("/")}><img className='nav-btn-img' src="https://cdn.onlinewebfonts.com/svg/img_50288.png" alt="" /></button>
